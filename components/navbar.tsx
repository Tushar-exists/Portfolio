...
export function Navbar({
  developerInitial = "T", // Default to "T" if not explicitly passed
  sections = [
    ...
    return (
      ...
      >
        <div className="flex-shrink-0 relative">
          <div className="w-9 h-9 rounded-full bg-[#08090a] dark:bg-slate-600 flex items-center justify-center text-white dark:text-black font-semibold">
            {developerInitial} {/* Render developerInitial here too! */}
          </div>
        </div>
