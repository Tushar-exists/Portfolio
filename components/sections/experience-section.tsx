...
const experiences: Experience[] = [
  {
    ...
    description: [
      ...
      "Applied state-of-the-art NLP techniques to build practical tools that improved internal workflow efficiency.",

    ],
    technologies: ["Generative AI", "Hugging Face", "TensorFlow", "Python",],
  },
